    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, to='index.AreaInfo', null=True)),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(max_length=20, null=True, blank=True)),
                ('goods', models.ForeignKey(to='index.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(to='index.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(to='index.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
